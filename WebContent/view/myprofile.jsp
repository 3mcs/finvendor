...
<link href="<%=request.getContextPath() %>/resources/myprofile/css/style-II.css" type="text/css" rel="stylesheet" />
...
<body>
	...
	<div class="wrapper">
	<div class="text_area"><div class="text_arw"> <a href="<%=request.getContextPath()%>/<%=RequestConstans.MarketAggregators.MARKETAGGREGATORS%>">My Profile</a> </div><div class="arw"> <img src="<%=request.getContextPath() %>/resources/singleasset/images/arw.png"  width="22" height="16" /></div> <div class="text_arw">View</div></div>
	<div class="row-fluid">
		<div class="span12">
...
<script type="text/javascript" src="<%=request.getContextPath() %>/resources/myprofile/js/jquery.bootstrap.wizard.min.js"></script>
</body>
</html>
