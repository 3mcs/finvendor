	...
	<script src="<%=request.getContextPath() %>/resources/newlogin/js/loginmain.js"></script>
	<script src="<%=request.getContextPath() %>/resources/newlogin/js/loginmodernizr.js"></script>
	<script>
		jQuery(document)
				.ready(function($) {
							var options = {
