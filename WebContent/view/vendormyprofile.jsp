...
<body>
									...
									<div class="form-wizard">
										...
										<div class="tab-pane active" id="tab1">
											...
											<div><br/> </div>
												...
												<div class="se">
													<a   class="btn" data-toggle="tab" class="step" onclick="updatePersonalInfo();">Update</a>
													  ...
													  <div class="modal-dialog">
													    <div class="modal-content">
													      ...
													      <div class="modal-body">
													         <input type="file" name="fileUpload" class="m-wrap largefileuploadconspopup" id="fileUpload" onchange="loadUploadFiles(this.value)">&nbsp;&nbsp;&nbsp;&nbsp;
													         <div id="selectedFiles"></div>
													         <a class="fileupload btnpopup btn-default">Upload</a> 
	...
	window.onload = function(){
		...
		document.getElementById("nameDisplayRemove").style.display="none";
	}
	</script> -->
