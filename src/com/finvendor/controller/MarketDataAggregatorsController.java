 ...
 */
@Controller
public class MarketDataAggregatorsController {

	private static Logger logger = Logger.getLogger(MarketDataAggregatorsController.class);
	...
	public ModelAndView loadRegionNameTypes(@RequestParam(value = "SiMhRaYuL", required = false) String regionName) {
		...
		try {
			...
			System.out.println("gettting regions lis size---:" + regions.size());
			System.out.println("region names---:" + regions);
